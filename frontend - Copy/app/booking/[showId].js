...
export default function BookingDetailsScreen() {
  ...
  const bookingMutation = useMutation({
    mutationFn: async () =>
      apiClient.post('/api/reservations', {
    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.headerBlock}>
          <View style={styles.eyebrowRow}>
            ...
            <Text style={styles.eyebrowText}>Time Selection</Text>
          </View>
          <Text style={styles.title}>Pick a session.</Text>
          <Text style={styles.subtitle}>Tap a session to open the seat map and choose your seats.</Text>
        </View>
      ...
      <View style={styles.footer}>
        <View style={styles.footerTopRow}>
          <View>
            <Text style={styles.footerLabel}>Initialize Node</Text>
