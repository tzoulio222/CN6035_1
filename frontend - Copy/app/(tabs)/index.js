...
import { ChevronRight, MapPin, Film, Ticket, Clock, Sparkles } from 'lucide-react-native';
import apiClient from '../../src/api/client';
import { EmptyState, Pill, ScreenShell, StatCard, Colors } from '../../src/components/ui';
...
export default function BrowseScreen() {
  ...
  const { data: shows, isLoading: loadingShows, refetch } = useQuery({
    queryKey: ['shows', selectedTheatreId],
    queryFn: async () => {
      const params = selectedTheatreId !== 'all' ? { theatreId: selectedTheatreId } : {};
